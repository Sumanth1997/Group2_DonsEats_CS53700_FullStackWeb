...
import { donsMenuItems } from './DonsMenuData';

const DonsAtWalbMenu = ({ cartItems, setCartItems }) => {
  const [activeCategory, setActiveCategory] = useState(Object.keys(donsMenuItems)[0]);
  ...
  return (
    <div className="menu-page">
      <div className="explore-menu">
        <h1>Don's at Walb Menu</h1>
        <div className="explore-menu-list">
          {Object.keys(donsMenuItems).map((category) => (
            <div
              key={category}
      ...
      <div className="food-display">
        ...
        {donsMenuItems[activeCategory] &&
          Object.entries(donsMenuItems[activeCategory]).map(([subcategory, items]) => (
